-- UGC Video Manager - Complete Database Setup
...
INSERT INTO youtube_channels (
    ...
    ('메인채널', 'https://youtube.com/@mainchannel', 'main', 'technology', '기술 리뷰 메인 채널', 'encrypted_id_1', 'encrypted_pass_1', 3),
    ('게임채널', 'https://youtube.com/@gamechannel', 'main', 'gaming', '게임 콘텐츠 채널', 'encrypted_id_2', 'encrypted_pass_2', 3),
    ('주부채널', 'https://youtube.com/@lifestylechannel', 'main', 'lifestyle', '라이프스타일 채널', 'encrypted_id_3', 'encrypted_pass_3', 3);
