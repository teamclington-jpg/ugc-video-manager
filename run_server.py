#!/usr/bin/env python3
"""
UGC Video Manager - Simple Server Runner
"""
...
try:
    ...
    class Settings:
        api_host = "0.0.0.0"
        api_port = 8000
        watch_folder_path = "/Users/thecity17/Desktop/teamclingotondrive/상품쇼츠DB"
    settings = Settings()
